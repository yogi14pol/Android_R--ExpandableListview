...
public class ExpandableListAdapterClass extends BaseExpandableListAdapter {
    ...
    public ExpandableListAdapterClass(Context context,List<String> expandableListTitle,
    ...
    public View getChildView(int listPosition, final int expandedListPosition,
        ...
        final String expandedListText = (String)getChild
                (listPosition,expandedListPosition);
